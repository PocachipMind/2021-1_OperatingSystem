...
※ 이 과제는 os1-3.c 의 출력값이 정답과 조금씩 값이 오차가있으므로 과제 조건을 100% 만족하지는 않습니다. 보고서를 읽을때 참고 바랍니다. ( 정답 코드를 최종적으로 완성 하였으나 작성한 환경이 임시적인 리눅스 환경(수업용 인스턴스/가상머신)이였기에, 저장소 작성 당시 코드를 찾기  기재하지 못하였습니다. )
